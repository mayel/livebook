defmodule LivebookWeb.Routes do
  @moduledoc """
  A plug that can be used in your router app's router to embed Livebook.
  ...
  ## Using with Plug or Phoenix
      ...
      defmodule MyApp.Router do
        ...
        forward "/authenticate", LivebookWeb.Routes
      end

  Now if you visit your app at `/livebook` you will see Livebook.
  """
  ...
  import LivebookWeb.Helpers, only: [base_url_path: 0]
  # must include these two Plugs?
  # plug :match
  # plug :dispatch
